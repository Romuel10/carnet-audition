# Carnet d’audition mobile — v3.0.0-beta.4
...
3. Ouvrir l’application : le bas de l’écran doit afficher `Audio natif prêt ... v3.0.0-beta.4`.
...
Si l’application se ferme encore, la beta.4 mémorise aussi les erreurs JavaScript et affiche explicitement quand le module natif n’est pas présent. Pour un crash natif Android, un logcat sera nécessaire.
